...
100% {top: 100vh;}
    ...
    if ($('#right .thread .postuid:first').length !== 0) {
        ...
        // updateQuotes() in YBoard framework is run when new messages are added into thread, 
        // so we can just add this to closure queue
        updateQuotes = () => {
            colorize();
            return updateQuotes;
        }
...
// TODO: voisiko tämän tehdä paremmin?
